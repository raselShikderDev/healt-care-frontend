    ...
    return (
        <div className="min-h-screen w-full relative">
            ...
            <section className="relative overflow-hidden">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col-reverse lg:flex-row items-center gap-12">
                    {/* ===== Left Side ===== */}
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-10">
                            ...
                            <Button asChild variant="outline" size="lg">
                                <Link href="/healthplans" className="text-primary">Book Appointment</Link>
                            </Button>
                        </div>
                        ...
                        <Card className="w-full max-w-md shadow-lg border border-blue-100">
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground text-center mt-4">
                                    Our AI will suggest the best specialists based on your symptoms.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
